...
import org.example.sportclub.JwtUtils;
import org.example.sportclub.data.JwtResponseDTO;
import org.example.sportclub.data.UserDataRequestDTO;
import org.example.sportclub.entity.Role;
import org.example.sportclub.entity.User;
import org.example.sportclub.repo.RoleRepository;
...
public class AuthController {
    ...
    public ResponseEntity<?> register(@RequestBody UserDataRequestDTO req) {
        ...
        Role userRole = roleRepo.findByName(Role.ERole.ROLE_USER).orElseThrow();
    ...
    public ResponseEntity<JwtResponseDTO> login(@RequestBody UserDataRequestDTO req) {
        ...
        List<String> roles = ud.getAuthorities().stream().map(Objects::toString).toList();
